...
Shared spec format for the savia monorepo. Sourced from savia-mobile/docs/guides/SPECCING.md.
...
We're heavily based on Joel Spolsky's Painless Functional Specifications - Part 2: What's a Spec?
...
In this section, you will present a black box diagram. A black box diagram, is an object which can be viewed in terms of its input, ouput and messages without any knowledge of its internal workings. Wikipedia.
...
In the technical spec, you describe the implementation using pseudo-code (Check Why should I use pseudo-code).
...
Diagrams are your friends but you should only include ASCII diagrams as they're the most text friendly out there. You can use services like asciiflow for easy edition.
